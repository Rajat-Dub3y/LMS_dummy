    ...
    <div className="selected-course" >
        ...
        <div className="selected-course__content">
            ...
            <div className="selected-course__sections">
                <h4 className="selected__section-title">Course Content</h4>
            ...
            <div className="selected-course__footer">
                ...
                <Button onClick={()=>handleEnrollNow(course.courseId)} className="bg-primary-700 hover:bg-primary-600" >Enroll Now</Button>
            </div>
        </div>
    </div>
  )
