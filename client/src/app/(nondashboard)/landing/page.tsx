    ...
    >
        ...
        >
            <div className="landing__hero-content">
                ...
                <p className="landing__description">
                    ...
                    <br />
                    Corses when you need them and want them.
                </p>
                <div className="landinf__cta">
        ...
        >
            ...
            <p className="landing__featured-description">
                From beginner to advanced, in all industry, we have the right
                courses just for you and preparing your entire journey for learning
                and makeing the most 
            </p>
            <div className="landing__tags">
                {["web Dev","enterprise IT","react next js","web development","enterprice IT"].map((tag,index)=>(
            ...
            <div className="landing__courses">
                {courses && courses.slice(0,4).map((course,index)=>(
                    <motion.div
                      ...
                      viewport={{amount:0.4}}
                    >
                        <CourseCardSearch onClick={()=>handleCourseClick(course.courseId)} course={course} />
                    </motion.div>
                ))}
            </div>
        </motion.div>
