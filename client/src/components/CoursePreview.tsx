...
const CoursePreview = ({course}:CoursePreviewProps) => {
  ...
  return (
    <div className="course-preview">
        <div className="course-preview___container">
            <div className="course-preview__image-wrapper">
                <Image src={course.image || "/course=preview-placeholder.png" } alt="Course Preview" width={640} height={360} className="w-full" />
            </div>
            <div>
                <h2 className="course-preview__title">{course.title}</h2>
                <p className="text-grey-400 text-md mb-4">By {course.teacherName}</p>
