...
const WizardSteppers = ({currentStep}:WizardStepperProps) => {
  return (
            ...
            {[1,2,3].map((step,index)=>(
                <React.Fragment key={step} >
                    <div className="wizard-stepper__step">
                        ...
                        <p className={cn("wizard-stepper__text",{"wizard-stepper__text--active":currentStep>=step,
